            ...
            if ((Integer) cg.getNextChoice() == 0) { // check bounds of the index
                ...
                if (pc.simplify()) { // satisfiable
                    ...
                    for (int i = 0; i < arrayLen; i++) {
                        Pair<Expression, String> arrayElementAttrOrVal = ArrayUtil.getArrayElement(arrayInfo, i);
                        Expression spfSymStoreVal = SPFToGreenExpr((gov.nasa.jpf.symbc.numeric.Expression) symStoreVal);
