    ...
    if (cname.equals("java.lang.String")
      ...
      for (int i = 0; i < numStackSlots; i++) {
        ...
        if (sym_v1 != null) {
          ...
          } else if (sym_v1 instanceof IntegerExpression && cname.equals(
...
//					return invInst;
  ...
  private boolean handleCharAt(JVMInvokeInstruction invInst, ThreadInfo th) {
    ...
    if ((sym_v1 == null) & (sym_v2 == null)) {
      throw new RuntimeException(
          "ERROR: symbolic string method must have one symbolic operand: HandleCharAt");
    } else {
      int s1 = sf.pop();
      int s2 = sf.pop();
  ...
  public void handleIndexOf1(JVMInvokeInstruction invInst, ThreadInfo th) {
    ...
    if (sym_v1 == null && sym_v2 == null) {
      throw new RuntimeException(
          "ERROR: symbolic string method must have one symbolic operand: HandleIndexOf1");
    } else {
  ...
  public void handleIndexOf2(JVMInvokeInstruction invInst, ThreadInfo th) {
    ...
    if (sym_v1 == null && sym_v2 == null && intExp == null) {
      throw new RuntimeException(
          "ERROR: symbolic string method must have one symbolic operand: HandleIndexOf2");
    } else {
      ...
      if (intExp != null) {
        ...
        if (sym_v1 != null) {
          ...
          if (sym_v2 != null) {
            ...
            if (s2char) {
              result = new StringConstant(val)._indexOf(new IntegerConstant(s2),
                  new IntegerConstant(i1));
            } else {
              ElementInfo e2 = th.getElementInfo(s2);
              String val2 = e2.asString();
  ...
  public void handleintValue(JVMInvokeInstruction invInst, ThreadInfo th) {
    ...
    if (sym_v3 == null) {
      throw new RuntimeException(
          "ERROR: symbolic string method must have one symbolic operand: HandleintValue");
    } else {
      if (sym_v3 instanceof IntegerExpression) {
        IntegerExpression sym_v2 = (IntegerExpression) sym_v3;
        sf.pop();
  ...
  public void handlelongValue(JVMInvokeInstruction invInst, ThreadInfo th) {
    ...
    if (sym_v3 == null) {
      throw new RuntimeException(
          "ERROR: symbolic string method must have one symbolic operand: hanldeLongValue");
    } else {
      if (sym_v3 instanceof IntegerExpression) {
        IntegerExpression sym_v2 = (IntegerExpression) sym_v3;
        sf.pop();
  ...
  public void handlefloatValue(JVMInvokeInstruction invInst, ThreadInfo th) {
    ...
    if (sym_v3 == null) {
      throw new RuntimeException(
          "ERROR: symbolic method must have symbolic string operand: hanldeFloatValue");
    } else {
  ...
  public void handledoubleValue(JVMInvokeInstruction invInst, ThreadInfo th) {
    ...
    if (sym_v3 == null) {
      throw new RuntimeException(
          "ERROR: symbolic method must have symbolic string operand: hanldeDoubleValue");
    } else {
      if (sym_v3 instanceof RealExpression) {
        RealExpression sym_v2 = (RealExpression) sym_v3;
        sf.pop();
...
//                throw new RuntimeException("ERROR: cannot handle creation of a string from a symbolic string");
  ...
  private void handleBooleanStringInstructions(JVMInvokeInstruction invInst, ThreadInfo th,
  ...
  public Instruction handleReplace(JVMInvokeInstruction invInst, ThreadInfo th) {
    ...
    if ((sym_v1 == null) & (sym_v2 == null) & (sym_v3 == null)) {
      throw new RuntimeException(
          "ERROR: symbolic string method must have one symbolic operand: HandleReplace");
    } else {
      int s1 = sf.pop();
      int s2 = sf.pop();
      int s3 = sf.pop();
  ...
  public Instruction handleValueOf(JVMInvokeInstruction invInst, ThreadInfo th) {
    ...
    if (cname.equals("java.lang.String")) {
      ...
      if (argTypes[0].equals("int")) {
        ...
        throw new RuntimeException(
            "ERROR: Input parameter type not handled in Symbolic String ValueOf");
      }
  ...
  public void handleIsEmpty(JVMInvokeInstruction invInst, ThreadInfo th) {
    ...
    if (sym_v1 == null) {
      throw new RuntimeException(
          "ERROR: symbolic string method must have one symbolic operand: HandleIsEmpty");
    } else {
...
//                    //sf.push(0, true);
    ...
    if (sym_v3 == null) {
      ...
      if (conditionValue) {
        ...
        if (!pc.simplify()) {// not satisfiable
          ...
          throw new RuntimeException(
              "ERROR: Possible Float Format Type Exception - Path Terminated");
  ...
  public Instruction handleIntValueOf(JVMInvokeInstruction invInst, ThreadInfo th) {
    ...
    if (sym_v1 == null) {
      throw new RuntimeException(
          "ERROR: symbolic string method must have symbolic operand: handleIntValueOf");
    } else {
      sf.pop();
  ...
  public Instruction handleFloatValueOf(JVMInvokeInstruction invInst, ThreadInfo th) {
    ...
    if (sym_v1 == null) {
      throw new RuntimeException(
          "ERROR: symbolic string method must have symbolic operand: handleFloatValueOf");
    } else {
      sf.pop();
      StringExpression sym_v2 = StringExpression._valueOf(sym_v1);
      int objRef = th.getHeap().newString("", th).getObjectRef(); /*
  ...
  public Instruction handleLongValueOf(JVMInvokeInstruction invInst, ThreadInfo th) {
    ...
    if (sym_v1 == null) {
      throw new RuntimeException(
          "ERROR: symbolic string method must have symbolic operand: handleLongValueOf");
    } else {
      sf.popLong();
      StringExpression sym_v2 = StringExpression._valueOf(sym_v1);
      int objRef = th.getHeap().newString("", th).getObjectRef(); /*
  ...
  public Instruction handleDoubleValueOf(JVMInvokeInstruction invInst, ThreadInfo th) {
    ...
    if (sym_v1 == null) {
      throw new RuntimeException(
          "ERROR: symbolic string method must have symbolic operand: handleDoubleValueOf");
    } else {
      sf.popLong();
      StringExpression sym_v2 = StringExpression._valueOf(sym_v1);
      int objRef = th.getHeap().newString("", th).getObjectRef(); /*
  ...
  public Instruction handleConcat(JVMInvokeInstruction invInst, ThreadInfo th) {
    ...
    if ((sym_v1 == null) & (sym_v2 == null)) {
      throw new RuntimeException(
          "ERROR: symbolic string method must have one symbolic operand: handleConcat");
    } else {
      int s1 = sf.pop();
      int s2 = sf.pop();
  ...
  public Instruction handleAppend(JVMInvokeInstruction invInst, ThreadInfo th) {
    ...
    if (argTypes[0].equals("java.lang.CharSequence")) {
      ...
      if (firstParam instanceof StringExpression
          || firstParam == null /*possibly an string constant*/) {
        ...
        throw new RuntimeException(
            "Unhandled CharSequence at Symbolic String Append; concrete type is:"
                + firstParam.getClass());
      }
    }
    if (isCharSequence && argTypes.length == 3) { //append(charSequence,int,int)
    ...
    } else if ((argTypes[0].equals("java.lang.StringBuilder")) || (argTypes[0].equals(
      ...
      throw new RuntimeException(
          "ERROR: Input parameter type not handled in Symbolic String Append");
    }
  ...
  public void setVariableAttribute(ElementInfo ei, JVMInvokeInstruction invInst, ThreadInfo th,
      StackFrame sf, int idx,
      Object sym_v2) {
  ...
  public void handleIntAppend(JVMInvokeInstruction invInst, ThreadInfo th) {
    ...
    if ((sym_v1 == null) & (sym_v2.getstr() == null)) {
      throw new RuntimeException(
          "ERROR: symbolic string method must have one symbolic operand: hanldeIntAppend");
    } else {
      int s1 = sf.pop();
      int s2 = sf.pop();
      if (sym_v1 == null) { // operand 0 is concrete
...
/*
  ...
  public Instruction handletoString(JVMInvokeInstruction invInst, ThreadInfo th) {
    ...
    if ((sym_v1 == null)) {
      throw new RuntimeException(
          "ERROR: symbolic string method must have symbolic operand: toString");
    } else {
      sf.pop();
  ...
  public void handleprintln(JVMInvokeInstruction invInst, ThreadInfo th, boolean doPrintln) {
    ...
    if ((sym_v1 == null)) {
      throw new RuntimeException(
          "ERROR: symbolic string method must have symbolic operand: println");
    } else {
      if (flag) {
        sf.popLong();
      } else {
