...
public class ContentReader extends Reader {
   ...
   * Creates the reader.
   *
   * @param delimiter the delimiter, as a backwards string, that will indicate the end of the stream
   * @param useLowLevelReader true if &amp; needs to be left untouched; false if entities need to be
   *     processed
   */
