...
echo "Running 5 step - mode 2"
MAX_STEPS=5 && export MAX_STEPS && runSPF-wbs $VERIDIR/src/examples/veritesting/wbs/RunWBS.mode2.jpf >& $VERIDIR/logs/RunWBS.mode2.$(($MAX_STEPS))step.log
echo "Running 5 step - mode 3"
MAX_STEPS=5 && export MAX_STEPS && runSPF-wbs $VERIDIR/src/examples/veritesting/wbs/RunWBS.mode3.jpf >& $VERIDIR/logs/RunWBS.mode3.$(($MAX_STEPS))step.log
echo "Running 5 step - mode 4"
MAX_STEPS=5 && export MAX_STEPS && runSPF-wbs $VERIDIR/src/examples/veritesting/wbs/RunWBS.mode4.jpf >& $VERIDIR/logs/RunWBS.mode4.$(($MAX_STEPS))step.log
