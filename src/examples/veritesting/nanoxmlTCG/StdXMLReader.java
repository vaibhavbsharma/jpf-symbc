package veritesting.nanoxmlTCG;/* StdXMLReader.java                                               NanoXML/Java
 *
 * $Revision: 1.5 $
...
//    private LineNumberReader currentLineReader;
     ...
     */
    public static veritesting.nanoxmlTCG.StdXMLReader stringReader(String str)
    {
    	StringReader s = new StringReader(str);
        return new veritesting.nanoxmlTCG.StdXMLReader(s);
    }
