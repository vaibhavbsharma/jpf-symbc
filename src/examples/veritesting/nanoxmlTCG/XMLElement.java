package veritesting.nanoxmlTCG;/* XMLElement.java                                                 NanoXML/Java
 *
 * $Revision: 1.2 $
    ...
    implements Serializable
{
     ...
     */
    public void addChild(veritesting.nanoxmlTCG.XMLElement child)
    {
        if (child == null) {
        ...
        if ((child.getName() == null) && (! this.children.isEmpty())) {
            veritesting.nanoxmlTCG.XMLElement lastChild = (veritesting.nanoxmlTCG.XMLElement) this.children.lastElement();
     ...
     */
    public void removeChild(veritesting.nanoxmlTCG.XMLElement child)
    {
        if (child == null) {
            throw new IllegalArgumentException("child must not be null");
        }
     ...
     */
    public veritesting.nanoxmlTCG.XMLElement getChildAtIndex(int index)
        throws ArrayIndexOutOfBoundsException
    {
        return (veritesting.nanoxmlTCG.XMLElement) this.children.elementAt(index);
    }
     ...
     */
    public veritesting.nanoxmlTCG.XMLElement getFirstChildNamed(String name)
    {
        Enumeration _enum = this.children.elements();
        
        while (_enum.hasMoreElements()) {
            veritesting.nanoxmlTCG.XMLElement child = (veritesting.nanoxmlTCG.XMLElement) _enum.nextElement();
