package veritesting.nanoxmlTCG;/* XMLParserFactory.java                                           NanoXML/Java
 *
 * $Revision: 1.2 $
...
public class XMLParserFactory
{
    ...
    {
        String className = System.getProperty(veritesting.nanoxmlTCG.XMLParserFactory.CLASS_KEY,
                                              veritesting.nanoxmlTCG.XMLParserFactory.DEFAULT_CLASS);
        return veritesting.nanoxmlTCG.XMLParserFactory.createXMLParser(className,
                                                new StdXMLBuilder(),
                                                null, null);
    }
               ...
               IllegalAccessException
    {
        String className = System.getProperty(veritesting.nanoxmlTCG.XMLParserFactory.CLASS_KEY,
                                              veritesting.nanoxmlTCG.XMLParserFactory.DEFAULT_CLASS);
        return veritesting.nanoxmlTCG.XMLParserFactory.createXMLParser(className, builder, reader,
                                                validator);
    }
               ...
               IllegalAccessException
    {
        ...
        if (validator == null) {
            try {
                cls = Class.forName(veritesting.nanoxmlTCG.XMLParserFactory.VALIDATOR_CLASS);
