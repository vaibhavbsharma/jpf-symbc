...
public class Filter {
    ...
    */
    public void addConstraint(String name, tcgbenchmarks.siena.AttributeConstraint a) {
    ...
    */
    public void addConstraint(String s, short op, String sval) {
    	addConstraint(s,new tcgbenchmarks.siena.AttributeConstraint(op,sval));
    };
    ...
    */
    public void addConstraint(String s, short op, int ival) {
    	addConstraint(s,new tcgbenchmarks.siena.AttributeConstraint(op,ival));
    };
    ...
    */
    public void addConstraint(String s, short op, long lval) {
    	addConstraint(s,new tcgbenchmarks.siena.AttributeConstraint(op,lval));
    };
    ...
    */
    public void addConstraint(String s, short op, boolean bval) {
    	addConstraint(s,new tcgbenchmarks.siena.AttributeConstraint(op,bval));
    };
    ...
    */
    public void addConstraint(String s, short op, double dval) {
    	addConstraint(s,new tcgbenchmarks.siena.AttributeConstraint(op,dval));
    };
    ...
    */
    public void addConstraint(String s, String sval) {
    	addConstraint(s,new tcgbenchmarks.siena.AttributeConstraint(tcgbenchmarks.siena.AttributeConstraint.EQ,sval));
    };
    ...
    */
    public void addConstraint(String s, int ival) {
    	addConstraint(s,new tcgbenchmarks.siena.AttributeConstraint(tcgbenchmarks.siena.AttributeConstraint.EQ,ival));
    };
    ...
    */
    public void addConstraint(String s, boolean bval) {
    	addConstraint(s,new tcgbenchmarks.siena.AttributeConstraint(tcgbenchmarks.siena.AttributeConstraint.EQ,bval));
    };
    ...
    */
    public void addConstraint(String s, long lval) {
    	addConstraint(s,new tcgbenchmarks.siena.AttributeConstraint(tcgbenchmarks.siena.AttributeConstraint.EQ,lval));
    };
    ...
    */
    public void addConstraint(String s, double dval) {
    	addConstraint(s,new tcgbenchmarks.siena.AttributeConstraint(tcgbenchmarks.siena.AttributeConstraint.EQ,dval));
    };
