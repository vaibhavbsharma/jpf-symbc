package tcgbenchmarks.nanoxmlTCG;/* XMLElement.java                                                 NanoXML/Java
 *
 * $Revision: 1.2 $
    ...
    implements Serializable
{
     ...
     */
    public void addChild(tcgbenchmarks.nanoxmlTCG.XMLElement child)
    {
        if (child == null) {
        ...
        if ((child.getName() == null) && (! this.children.isEmpty())) {
            tcgbenchmarks.nanoxmlTCG.XMLElement lastChild = (tcgbenchmarks.nanoxmlTCG.XMLElement) this.children.lastElement();
     ...
     */
    public void removeChild(tcgbenchmarks.nanoxmlTCG.XMLElement child)
    {
        if (child == null) {
            throw new IllegalArgumentException("child must not be null");
        }
     ...
     */
    public tcgbenchmarks.nanoxmlTCG.XMLElement getChildAtIndex(int index)
        throws ArrayIndexOutOfBoundsException
    {
        return (tcgbenchmarks.nanoxmlTCG.XMLElement) this.children.elementAt(index);
    }
     ...
     */
    public tcgbenchmarks.nanoxmlTCG.XMLElement getFirstChildNamed(String name)
    {
        Enumeration _enum = this.children.elements();
        
        while (_enum.hasMoreElements()) {
            tcgbenchmarks.nanoxmlTCG.XMLElement child = (tcgbenchmarks.nanoxmlTCG.XMLElement) _enum.nextElement();
