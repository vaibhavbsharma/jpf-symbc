package tcgbenchmarks.nanoxmlTCG;/* StdXMLReader.java                                               NanoXML/Java
 *
 * $Revision: 1.5 $
...
//    private LineNumberReader currentLineReader;
     ...
     */
    public static tcgbenchmarks.nanoxmlTCG.StdXMLReader stringReader(String str)
    {
    	StringReader s = new StringReader(str);
        return new tcgbenchmarks.nanoxmlTCG.StdXMLReader(s);
    }
