package tcgbenchmarks.nanoxmlTCG;/* XMLParserFactory.java                                           NanoXML/Java
 *
 * $Revision: 1.2 $
...
public class XMLParserFactory
{
    ...
    {
        String className = System.getProperty(tcgbenchmarks.nanoxmlTCG.XMLParserFactory.CLASS_KEY,
                                              tcgbenchmarks.nanoxmlTCG.XMLParserFactory.DEFAULT_CLASS);
        return tcgbenchmarks.nanoxmlTCG.XMLParserFactory.createXMLParser(className,
                                                new StdXMLBuilder(),
                                                null, null);
    }
               ...
               IllegalAccessException
    {
        String className = System.getProperty(tcgbenchmarks.nanoxmlTCG.XMLParserFactory.CLASS_KEY,
                                              tcgbenchmarks.nanoxmlTCG.XMLParserFactory.DEFAULT_CLASS);
        return tcgbenchmarks.nanoxmlTCG.XMLParserFactory.createXMLParser(className, builder, reader,
                                                validator);
    }
               ...
               IllegalAccessException
    {
        ...
        if (validator == null) {
            try {
                cls = Class.forName(tcgbenchmarks.nanoxmlTCG.XMLParserFactory.VALIDATOR_CLASS);
