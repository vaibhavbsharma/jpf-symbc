// Copied from https://raw.githubusercontent.com/c9n/hadoop/master/hadoop-common-project/hadoop-common/src/main/java/org/apache/hadoop/util/PureJavaCrc32C.java
// Edits made to remove references to other classes and annotations defined in hadoop
/**
...
//        crc32C.update(bytes[0]);
        ...
        crc32C.update(bytes, 0, bytes.length);
//        crc32C.update(bytes[0]);
        if (crc32Result == (int) crc32C.getValue()) {
