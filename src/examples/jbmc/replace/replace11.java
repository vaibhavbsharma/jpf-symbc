...
//		subPara[4] = i6;
    ...
    public static void main(String[] args) {
        mainProcess(CProver.nondetChar(), CProver.nondetChar(), CProver.nondetChar(), CProver.nondetChar(),
                CProver.nondetChar(), CProver.nondetChar(), CProver.nondetChar(), CProver.nondetChar(),
                CProver.nondetChar(), CProver.nondetChar(), CProver.nondetChar());
    }
