package jbmc.apachecli;


import org.cprover.CProver;
import veritesting.apachecli.BasicParser;
import veritesting.apachecli.CommandLine;
import veritesting.apachecli.CommandLineParser;
import veritesting.apachecli.Option;
import veritesting.apachecli.Options;
...
public class CLI_jbmc {
    ...
    private static void mainProcess(char a, char b, char c, char d, char e, char f, char g, char h, boolean stop) {
        ...
        string[0][0] =  CProver.nondetChar();
        string[1][0] =  CProver.nondetChar();
        string[2][0] = CProver.nondetChar();
