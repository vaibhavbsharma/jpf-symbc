...
/*
Run this using the following command in the build/examples/ directory:
jbmc  --classpath /Users/svaib/git_repos/java-ranger/build/examples/  jbmc/tcas/tcas_jbmc.class --unwind 50
 */
public class tcas_jbmc {
	...
	private static void mainProcess(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9, int a10, int a11, int a12) {//,
		initialize();
		Cur_Vertical_Sep = a1;
		if (a2 == 0) {
