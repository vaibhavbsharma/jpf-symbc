...
import veritesting.siena.SENP;
import veritesting.siena.SENPPacket;
...
//	public static SENPPacket packet = new SENPPacket();
    public static void main(String[] args) throws Exception {
        mainProcess(CProver.nondetInt(), CProver.nondetInt(), CProver.nondetInt(), CProver.nondetInt(),
                CProver.nondetInt(), CProver.nondetInt(), CProver.nondetInt(), CProver.nondetInt(),
                CProver.nondetInt());
    }
