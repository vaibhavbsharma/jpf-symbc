...
rm ../logs/apachecli/ApacheCLIEqCheckTCG.log
...
runEquivelanceCheck $COVERAGEDIR/src/examples/veritesting/apachecli/ApacheCLIEqCheckTCG.jpf>& $COVERAGEDIR/logs/apachecli/ApacheCLIEqCheckTCG.log
