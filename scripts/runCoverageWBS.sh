...
if [ "$1" = "mac" ]; then
  exit 1
  #export DYLD_LIBRARY_PATH=/Users/sohahussein/git/rangerCopy/java-ranger/lib
  export TARGET_CLASSPATH_WALA=/Users/sohahussein/git/rangerCopy/java-ranger/build/examples/
  alias runCoverage='java -Djava.library.path="/Users/sohahussein/git/rangerCopy/java-ranger/lib" -jar /Users/sohahussein/git/jpf-core/build/RunJPF.jar '
else
