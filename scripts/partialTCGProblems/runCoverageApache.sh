...
#&& runCoverage $COVERAGEDIR/src/examples/tcgbenchmarks/runconfig/apachecli/partialproblem/apacheJR_Collect.mode2_onTheGoOFF.jpf >& $COVERAGEDIR/logs/log_cli/partialproblem/apacheJRCollect.mode2_onTheGoOFF_steps$MAX_STEPS.log \
