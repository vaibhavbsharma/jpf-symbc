...
#runCoverage $COVERAGEDIR/src/examples/tcgbenchmarks/runconfig/siena/partialproblem/sienaJR_Collect.mode2_onTheGoOFF.jpf >& $COVERAGEDIR/logs/log_siena/partialproblem/sienaJRCollect.mode2_onTheGoOFF_steps$MAX_STEPS.log \
