...
&& runCoverage $COVERAGEDIR/src/examples/tcgbenchmarks/runconfig/tcas/partialproblem/TCASJR_Collect.mode3.jpf >& $COVERAGEDIR/logs/log_tcas/partialproblem/TCAS_JR_Collect.mode3_steps$MAX_STEPS.log \
&& echo "JR mode3 onTheGoON finished" \
&& runCoverage $COVERAGEDIR/src/examples/tcgbenchmarks/runconfig/tcas/partialproblem/TCASJR_Collect.mode4.jpf >& $COVERAGEDIR/logs/log_tcas/partialproblem/TCAS_JR_Collect.mode4_steps$MAX_STEPS.log \
&& echo "JR mode4 onTheGoON finished" \
&& runCoverage $COVERAGEDIR/src/examples/tcgbenchmarks/runconfig/tcas/partialproblem/TCASJR_Collect.mode5.jpf >& $COVERAGEDIR/logs/log_tcas/partialproblem/TCAS_JR_Collect.mode5_steps$MAX_STEPS.log \
&& echo "JR mode5 onTheGoON finished" \
&& runCoverage $COVERAGEDIR/src/examples/tcgbenchmarks/runconfig/tcas/partialproblem/TCASJR_Collect.mode3PlainJR.jpf >& $COVERAGEDIR/logs/log_tcas/partialproblem/TCASJR_Collect.mode3PlainJR_steps$MAX_STEPS.log \
&& echo "JR mode3 PlainJR finished"\
&& runCoverage $COVERAGEDIR/src/examples/tcgbenchmarks/runconfig/tcas/partialproblem/TCASJR_Collect.mode3_onTheGoOFF.jpf >& $COVERAGEDIR/logs/log_tcas/partialproblem/TCAS_JR_Collect.mode3_onTheGoOFF_steps$MAX_STEPS.log \
&& echo "JR mode3 onTheGoOFF finished" \

#runCoverage $COVERAGEDIR/src/examples/tcgbenchmarks/runconfig/tcas/partialproblem/TCASCollect.jpf >& $COVERAGEDIR/logs/log_tcas/partialproblem/TCASCollect_steps$MAX_STEPS.log \
#&& echo "SPF branch onTheGoON finished" \
#&& runCoverage $COVERAGEDIR/src/examples/tcgbenchmarks/runconfig/tcas/partialproblem/TCASJR_Collect.mode3.jpf >& $COVERAGEDIR/logs/log_tcas/partialproblem/TCAS_JR_Collect.mode3_onTheGoON_steps$MAX_STEPS.log \
#&& echo "JR mode3 onTheGoON finished" \
#&& runCoverage $COVERAGEDIR/src/examples/tcgbenchmarks/runconfig/tcas/partialproblem/TCASJR_Collect.mode3_onTheGoOFF.jpf >& $COVERAGEDIR/logs/log_tcas/partialproblem/TCAS_JR_Collect.mode3_onTheGoOFF_steps$MAX_STEPS.log \
#&& echo "JR mode3 onTheGoOFF finished" \
#&& runCoverage $COVERAGEDIR/src/examples/tcgbenchmarks/runconfig/tcas/partialproblem/TCASJR_Collect.mode3PlainJR.jpf >& $COVERAGEDIR/logs/log_tcas/partialproblem/TCASJR_Collect.mode3PlainJR_steps$MAX_STEPS.log \
