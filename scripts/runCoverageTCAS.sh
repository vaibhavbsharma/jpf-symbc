...
runCoverage $COVERAGEDIR/src/examples/veritesting/test_case_gen/tcas/TCASJR_Collect.jpf >& $COVERAGEDIR/logs/tcas/TCASJRCollect_steps$2.log
runCoverage $COVERAGEDIR/src/examples/veritesting/test_case_gen/tcas/TCASJR_Collect_Guide.jpf >& $COVERAGEDIR/logs/tcas/TCASJR_Collect_Guide_steps$2.log