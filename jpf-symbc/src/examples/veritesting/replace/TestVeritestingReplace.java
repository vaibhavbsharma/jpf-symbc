...
public class TestVeritestingReplace  {
    ...
    public void checkEquality(ReplaceEqCheck v, Outputs outSPF, Outputs outJR) {
...
//        assert(outSPF == outJR);
    ...
    public Outputs SPFWrapper(ReplaceEqCheck v, int in0, int in1, int in2, int in3, int in4, int in5,
                              boolean b0, boolean b1, boolean b2, boolean b3, boolean b4, boolean b5,
                              char c0, char c1, char c2, char c3, char c4, char c5) {
    ...
    private Outputs NoVeritest(ReplaceEqCheck v, int in0, int in1, int in2, int in3, int in4, int in5,
                               boolean b0, boolean b1, boolean b2, boolean b3, boolean b4, boolean b5,
                               char c0, char c1, char c2, char c3, char c4, char c5){
        return SPFWrapperInner(v, in0, in1, in2, in3, in4, in5, b0, b1, b2, b3, b4, b5, c0, c1, c2, c3, c4, c5);
    }

    private Outputs SPFWrapperInner(ReplaceEqCheck v, int in0, int in1, int in2, int in3, int in4, int in5,
                                    boolean b0, boolean b1, boolean b2, boolean b3, boolean b4, boolean b5,
                                    char c0, char c1, char c2, char c3, char c4, char c5) {
    ...
    public Outputs JRWrapper(ReplaceEqCheck v, int in0, int in1, int in2, int in3, int in4, int in5,
                             boolean b0, boolean b1, boolean b2, boolean b3, boolean b4, boolean b5,
                             char c0, char c1, char c2, char c3, char c4, char c5) {
